...
import net.sasconsul.s2f.domain.Country;
import net.sasconsul.s2f.repository.CountryRepository;
...
import static net.sasconsul.s2f.web.rest.TestUtil.createFormattingConversionService;
