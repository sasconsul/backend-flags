...
import net.sasconsul.s2f.repository.ContinentRepository;
...
/**
 * REST controller for managing {@link net.sasconsul.s2f.domain.Continent}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ContinentResource {
    ...
    public ResponseEntity<Continent> updateContinent(@RequestBody Continent continent) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, continent.getId().toString()))
            .body(result);
    }
